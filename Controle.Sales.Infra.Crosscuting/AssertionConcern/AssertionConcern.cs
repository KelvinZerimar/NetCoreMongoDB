...
namespace Infra.Cross.AssertionConcern
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentFalse<TException>(bool boolValue, string message) where TException : System.Exception
        {
            if (boolValue)
                throw (TException)Activator.CreateInstance(typeof(TException), message);
        }
        ...
        public static void AssertArgumentTrue<TException>(bool boolValue, string message) where TException : System.Exception
        {
            if (!boolValue)
                throw (TException)Activator.CreateInstance(typeof(TException), message);
        }

        public static void AssertStateFalse<TException>(bool boolValue, string message) where TException : System.Exception
        {
            if (boolValue)
                throw (TException)Activator.CreateInstance(typeof(TException), message);
        }

        public static void AssertStateTrue<TException>(bool boolValue, string message) where TException : System.Exception
        {
            if (!boolValue)
                throw (TException)Activator.CreateInstance(typeof(TException), message);
        }
